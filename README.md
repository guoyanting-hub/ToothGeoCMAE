...
<img src="images/Overall.jpg" width="600"/>
...
### Data Preparing
The data used in this project is the Teeth3DS and 3D-IOSSeg dataset, which should be placed in the data directory in the following structure:
```
data
    | train
        | ×××.obj
...
bash pretrain.sh
```
<img src="images/Pretraining.jpg" width="700"/>  
