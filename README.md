...
3. Self-Supervised Pre-training (Stage 1): Train the encoder on unlabeled dental meshes to learn general geometric features
bash pretrain.sh

4. Supervised Fine-tuning (Stage 2): Fine-tune the pre-trained encoder on a limited set of labeled data (e.g., 10%, 30%, or 100%)
bash finetune.sh
